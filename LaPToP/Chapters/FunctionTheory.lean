...
are the extended reals other than $`\pm\infty`. The opening example is proved
too: every value of $`\Updownarrow n \cdot (1 + 1/n)^n` is $`e` (`isLimit_eSeq_iff`, from
Mathlib's limit of $`(1 + t/n)^n`).
:::
